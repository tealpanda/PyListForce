...
parser.add_argument('--file', default="output.txt", help="The file to write scan results to.")
...
for word in dictionary:
    ...
    try:
        ...
        write_line(args['file'], url + ',Exception')

    if (response):
        if (response.status_code != 404):
            write_line(args['file'], url + ',' + str(response.status_code))
